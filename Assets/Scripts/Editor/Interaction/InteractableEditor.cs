...
public class InteractableEditor : EditorWithSubEditors<ConditionCollectionEditor, ConditionCollection>
{
	...
	private SerializedProperty windowProperty;
	...
	private const string interactablePropWindowName = "window";
    ...
    private void OnEnable ()
    {
		...
		windowProperty = serializedObject.FindProperty (interactablePropWindowName);
    ...
    public override void OnInspectorGUI ()
    {
		...
		EditorGUILayout.PropertyField (windowProperty);
